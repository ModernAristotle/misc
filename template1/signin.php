...
<?php if (empty($_SESSION['username'])) { ?>
     <body> 
      <div class="signinformCont center fnClose" style="display: block;">
       <div class="frmHdng">
        <h3 class="mrgnpdng" align="center">Sign in here</h3>
       </div>
       <br />
      <!--<p class="closeicn">x</p>-->
       <form action="index.php" method="post" id="loginForm" class="formLogin" name="frm" enctype="multipart/form-data" onsubmit="return validatelogin();">
        <div class="cntnr clear" style="padding: 10px 0px;">
         ...
         <div class="col-xs-12" align="center">       
          ...
          <input type="button" value="Sign up" class="btnSignUp btnBg btnStyle" />
         </div>
         <div class="clear"></div>
        </div>
       </form>
      ...
      <div class="entryGate center" style="display: none;">
       <div class="frmHdng">
        <h3 class="mrgnpdng" align="">Please enter Email ID or Mobile Number <a href="signin.php" class="fltrht linkSignin">Login</a></h3>
       </div>
       <br />
       <!--<p class="closeicn">x</p>-->
